...
@Composable
fun KirimBarangScreen(navController: NavController) {
    val categories = listOf(
        Category("Semua", isSelected = true),
        Category("Dokumen"),
        Category("Paket Kecil"),
        Category("Paket Besar"),
        Category("Ekspres"),
        Category("Kargo")
    )
    ...
    Scaffold(
        ...
        Column(
            ...
            SearchAndFilter("Cari layanan kirim barang...")
            CategoryList(categories = categories)
            KirimBarangList(services = services)
        }
    }
}

@Composable
fun KirimBarangList(services: List<KirimBarangService>) {
    Column(
        modifier = Modifier
            .fillMaxWidth()
        ...
        Row(
            ...
            Text(
                text = "Layanan Pengiriman Terbaru",
        ...
        LazyColumn(
            ...
            items(services.size) { index ->
                KirimBarangServiceItem(service = services[index])
            }
...
@Composable
fun KirimBarangServiceItem(service: KirimBarangService) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
            .height(120.dp)
